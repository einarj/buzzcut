class Tweets
  ...
  },
  {
    ...
    "text": "You would be right more often if you thought you were wrong.",
    "contributors": null,
    ...
    "user": {
      ...
      "geo_enabled": true,
      "notifications": false,
      "description": "Reality Technician, Twitter API team, synthesizer enthusiast; a most excellent adventure in timelines. I know it is hard to believe in something you cannot see.",
